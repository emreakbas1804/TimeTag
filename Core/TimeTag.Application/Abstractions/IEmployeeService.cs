...
public interface IEmployeeService
{
    ...
    Task<EntityResultModel> GetLog(int logId);
    Task<EntityResultModel> UpdateLog(int logId, LogType type, DateTime processTime);
    Task<LogType> GetLogType(string token);
    Task<int> GetEmployeeIdByToken(string token);
